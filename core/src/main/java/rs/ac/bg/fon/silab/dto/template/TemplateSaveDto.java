...
public class TemplateSaveDto extends TemplateDto {
    ...
    @NotEmpty(message = "{template.items.not.empty}")
    @Valid
    private List<TemplateItemDto> templateItems;

    public TemplateSaveDto() {}

    public TemplateSaveDto(String name, String description, Integer state, Integer companyId, List<TemplateItemDto> templateItems) {
